function scPlayerDrawUIAbility(argument0, argument1, argument2, argument3, argument4, argument5) {
	//Draw Player Ability
	///@arg x
	///@arg y
	///@arg size-in-pixels
	...
	scDrawNineSplice(sUIBox, _x - 8, _y - 8, _x + _size, _y + _size, _alpha, 0.8 * _alpha);
	...
	if (_time > 0) { //Still in cooldown
		...
		scDrawRect(_x, _y + (_size - (_size * _per)), _x + _size, _y + _size, c_yellow, false, 0.8 * _alpha);
