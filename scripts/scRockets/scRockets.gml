...
ds_map_add(weapons[roc], ROCKET_MAP.KBAMT, 35);
...
ds_map_add(weapons[roc], ROCKET_MAP.PARTICLE_AMT, oParticleHandler.ds_part_amt[? PARTICLES.ICE]);
...
//ds_map_add(weapons[roc], ROCKET_MAP.ROCKET_CREATE, scRocketSand_Create);
//ds_map_add(weapons[roc], ROCKET_MAP.ROCKET_STEP, scRocketSand_Step);
//ds_map_add(weapons[roc], ROCKET_MAP.ROCKET_DESTROY, scRocketSand_Destroy);
ds_map_add(weapons[roc], ROCKET_MAP.SHAKE_MAGNITUDE, 3);
