...
function scRocketDefaults() {

	var map = ds_map_create();
	map[? ROCKET_MAP.RECOIL] = 1 * TIME_SPEED; //Amount of recoil to push the player back
	...
	map[? ROCKET_MAP.TYPE] = WEAPON_ROCKET_TYPE.NONE; //Rocket type (must have)
	...
	map[? ROCKET_MAP.EXPLOSION_SCALE] = 2.5; //Explosions sprite size
	//SOUNDS
