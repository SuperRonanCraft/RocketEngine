...
function scUltimateGet(argument0, argument1) {
	...
	switch (type) {
		...
		case ULTIMATE_TYPE.VORTEX:
			ds_map[? ULTIMATE_MAP.NAME] = "All for one!";
			ds_map[? ULTIMATE_MAP.CASTED_SCRIPT] = scUltimateVortex;
			ds_map[? ULTIMATE_MAP.CAST_TIME] = 5;
			break;
		
		case ULTIMATE_TYPE.SPEEDUP:
			ds_map[? ULTIMATE_MAP.NAME] = "Let's go!";
