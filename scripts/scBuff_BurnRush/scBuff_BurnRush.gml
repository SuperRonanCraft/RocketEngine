...
if(findBuff(owner.buffs,"Chilled") || clock > dsBuff[?"time"]){
	//Return to normal speed
	owner.move_adj -= dsBuff[?"overallSpeed"];	
	show_debug_message(findBuff(owner.buffs,"Chilled"));
	//Remove Burn Rush
	...
	part_particles_create(global.ParticleSystem1,x + irandom_range(-10,10), y + irandom_range(-15,15) , oParticleHandler.partSmoke1,(abs( (clock - dsBuff[?"time"]) ) + 1) );
