...
if (despawn && ((shootable_map[? SHOOTABLE_MAP.HEALTH_BASE] <= 0 && player_map[? PLAYER_MAP.PLAYER_STATE] == PLAYERSTATE.DEAD && gravity_map[? GRAVITY_MAP.VSP] == 0) || image_alpha != 1)) { //Despawn player object
	image_alpha -= 0.025;
	if (image_alpha <= 0)
		instance_destroy();
}