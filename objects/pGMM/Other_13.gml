...
if (ds_list_size(p_list) == 2) {
	...
	tie = (p1.shootable_map[? SHOOTABLE_MAP.HEALTH] == p2.shootable_map[? SHOOTABLE_MAP.HEALTH]);
	if (!tie)
		if (p1.shootable_map[? SHOOTABLE_MAP.HEALTH] > p2.shootable_map[? SHOOTABLE_MAP.HEALTH]) {
