...
if (global.debug) {
	...
	scDrawText(bbox_left, bbox_top - 40, "KB - HSP: " + string(gravity_map[? GRAVITY_MAP.HSP_KNOCKBACK]), noone, 0.3);
	scDrawText(bbox_left, bbox_top - 25, "KB - VSP: " + string(gravity_map[? GRAVITY_MAP.VSP_KNOCKBACK]), noone, 0.3);
