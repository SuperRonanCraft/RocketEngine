...
ds_menu_main = scUICreateMenuPage(
	...
	["CONTROLLERS",		menu_element_type.page_transfer,	menu_page.info, "Setup controllers for players"]
);

ds_menu_info = scUICreateMenuPage(
...
//Pages of the menu
menu_pages = [ds_menu_main, ds_menu_info];

//The page index values (must be in order)
menu_pages_index = [menu_page.main, menu_page.info];
